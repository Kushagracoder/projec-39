...
function setup() {  
  ...
  space = createSprite(windowWidth - 1000,windowHeight - 350,30,20);
  space.addImage(spaceImage);
  space.velocityY = (5 + score/10);

  spaceShip = createSprite(windowWidth - 280,windowHeight -100);
...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    text("Year 2150 .....",canvas.width/2-300,canvas.height/2-250);
